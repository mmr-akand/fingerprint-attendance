...
@section('content')
<form action="/customer/register" class="signup-form form-small-space" id="signup-form" method="POST">
    {!! csrf_field() !!}
    <div class="log-card">
        <div class="log-block">
            <h4 class="log-title">গ্রাহক রেজিস্ট্রেশন</h4>
            ...
            <button class="btn btn-primary btn-lg mt-15 btn-block btn-sign">নিবন্ধন করুন</button>
        </div>
    </div>
</form>
<div class="text-center pt-3">
    <div class="text-sm text-lighter">
        ইতিমধ্যে একটি একাউন্ট আছে? <a href="{{url('/session/login')}}">প্রবেশ করুন</a>.
    </div>
</div>
@stop