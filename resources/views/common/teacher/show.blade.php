                            ...
                            <div class="col-md-7">
                                <div class="pl-4 text-right">
                                    ...
                                    @if(Sentinel::getUser()->phone == 'superadmin')
                                        ...
                                        <a href="/{{$panel}}/panel/school/{{$school->id}}/teacher/{{$teacher->id}}/delete" class="btn btn-danger" onclick="return ConfirmDelete();">Delete</a>
                                    @endif
                                    @if($panel != 'teacher')
...
<script>
    ...
    {
      var delCheck = confirm("Do you really want to delete the teacher?");
      if(delCheck)
        return true;
      else
        return false;
