...
<head>
    ...
    <link rel="stylesheet" href="/website/plugins/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="/website/plugins/ionicons/css/ionicons.min.css">
    <link rel="stylesheet" href="/website/plugins/icofont/css/icofont.css">
...
<body>
    <div class="error-hero d-flex align-items-center">
        <div class="container">
            <div class="row">
                @yield('content')
            </div>
