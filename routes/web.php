...
Route::group(['prefix' => 'admin', 'middleware' => 'sentinel-auth:super-admin'], function() {
    Route::group(['prefix' => 'panel'], function() {
        ...
        Route::get('school/{school}/delete', 'Admin\SchoolController@delete');
        ...
        Route::get('school/{school}/teacher/{teacher}/delete', 'Admin\TeacherController@delete');
...
Route::group(['prefix' => 'teacher', 'middleware' => 'sentinel-auth:teacher'], function() {
    Route::group(['prefix' => 'panel'], function() {
        ...
        Route::get('school/{school}/teacher/{teacher}/history', 'Teacher\AttendanceController@history');
